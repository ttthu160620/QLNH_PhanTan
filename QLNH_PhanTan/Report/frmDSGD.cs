...
namespace QLNH_PhanTan.Report
{
    public partial class frmDSGD : DevExpress.XtraEditors.XtraForm
    {
        ...
        {
            this.SP_SAOKEGIAODICHTableAdapter.Connection.ConnectionString = Program.connstr;
            this.SP_SAOKEGIAODICHTableAdapter.Fill(this.dS.SP_SAOKEGIAODICH, txtSOTK.Text.Trim(), dateFrom, dateTo);
            if (bdsRp_TK.Count == 0)
            {
