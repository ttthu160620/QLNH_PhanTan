...
namespace QLNH_PhanTan.Report
{
    public partial class frmDSTK : DevExpress.XtraEditors.XtraForm
    {
        ...
        private void DSSTK_Load(object sender, EventArgs e)
        {
            ...
            _comboItems.Add(new Data { Name = "Bến Thành", Value = "LAPTOPTHU\\SERVER1" });
            _comboItems.Add(new Data { Name = "Tân Định", Value = "LAPTOPTHU\\SERVER2" });
        ...
        {
            this.SP_DSTAIKHOANTableAdapter.Connection.ConnectionString = Program.connstr;
            String chiNhanh;
            if(cmbChiNhanh.SelectedValue == "LAPTOPTHU\\SERVER1")
            {
                chiNhanh = "BENTHANH";
            }
            else
            ...
            this.SP_DSTAIKHOANTableAdapter.Fill(this.dS.SP_DSTAIKHOAN, dateFrom, dateTo, chiNhanh, toanBo);
            if (bdsDSTK.Count == 0)
            {
